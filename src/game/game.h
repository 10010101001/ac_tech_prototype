...
#define AC_SERVER_PORT 42000
#define AC_LANINFO_PORT 41998
...
static const struct attackinfo { int gun, action, anim, vwepanim, hudanim, sound, hudsound, attackdelay, damage, spread, margin, projspeed, kickamount, range, rays, hitpush, exprad, ttl, use, mdl_kick_rot, mdl_kick_back; } attacks[NUMATKS] =
{
    ...
    { GUN_SUBGUN,  ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SUBGUN,  S_SUBGUN, 80, 16, 45, 0,    0, 30, 2048, 1, 5000,  0, 0, 0, 1, 2 },
    ...
    { GUN_ASSAULT,  ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_ASSAULT,  S_ASSAULT, 120, 22, 18, 0,    0, 30, 2048, 1, 5000,  0, 0, 0, 0, 2 },
